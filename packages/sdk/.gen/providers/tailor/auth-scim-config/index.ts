// https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/auth_scim_config
...
export interface AuthScimConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/auth_scim_config#actor_machine_user_name AuthScimConfig#actor_machine_user_name}
  */
  readonly actorMachineUserName: string;
  /**
  * The authorization configuration for SCIM operations.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/auth_scim_config#authorization AuthScimConfig#authorization}
  */
  readonly authorization: AuthScimConfigAuthorization;
  /**
  * The auth namespace of the SCIM config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/auth_scim_config#namespace AuthScimConfig#namespace}
  */
  readonly namespace: string;
  /**
  * The ID of the workspace that the SCIM config belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/auth_scim_config#workspace_id AuthScimConfig#workspace_id}
  */
...
export interface AuthScimConfigAuthorizationApiKeySecretValue {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/auth_scim_config#secret_name AuthScimConfig#secret_name}
  */
  readonly secretName: string;
  /**
  * The name of the vault.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/auth_scim_config#vault_name AuthScimConfig#vault_name}
  */
...
export interface AuthScimConfigAuthorizationApiKey {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/auth_scim_config#secret_value AuthScimConfig#secret_value}
  */
...
export interface AuthScimConfigAuthorization {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/auth_scim_config#api_key AuthScimConfig#api_key}
  */
  readonly apiKey?: AuthScimConfigAuthorizationApiKey;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/auth_scim_config#machine_user_token AuthScimConfig#machine_user_token}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/auth_scim_config tailor_auth_scim_config}
*/
export class AuthScimConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthScimConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/auth_scim_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/auth_scim_config tailor_auth_scim_config} Resource
  *
  * @param scope The scope in which to define this construct
