// https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor
...
export interface ExecutorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#description Executor#description}
  */
  readonly description?: string;
  /**
  * Whether this executor is disabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#disabled Executor#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * The name of this executor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#name Executor#name}
  */
  readonly name: string;
  /**
  * The operation to perform.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#operation Executor#operation}
  */
  readonly operation: ExecutorOperation;
  /**
  * The trigger for this executor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#trigger Executor#trigger}
  */
  readonly trigger: ExecutorTrigger;
  /**
  * The ID of the workspace that the executor belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#workspace_id Executor#workspace_id}
  */
  readonly workspaceId: string;
}
export interface ExecutorOperationFunctionInvokerMachineUser {
  /**
  * The auth namespace of the machine user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#auth_namespace Executor#auth_namespace}
  */
...
export function executorOperationFunctionInvokerMachineUserToTerraform(struct?: ExecutorOperationFunctionInvokerMachineUser | cdktf.IResolvable): any {
...
export function executorOperationFunctionInvokerMachineUserToHclTerraform(struct?: ExecutorOperationFunctionInvokerMachineUser | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ExecutorOperationFunctionInvokerMachineUserOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ExecutorOperationFunctionInvokerMachineUser | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ExecutorOperationFunctionInvokerMachineUser | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export interface ExecutorOperationFunctionInvoker {
  /**
  * Attach the operation to an event user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#event_user Executor#event_user}
  */
  readonly eventUser?: boolean | cdktf.IResolvable;
  /**
  * Attach the operation to a machine user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#machine_user Executor#machine_user}
  */
  readonly machineUser?: ExecutorOperationFunctionInvokerMachineUser;
}

export function executorOperationFunctionInvokerToTerraform(struct?: ExecutorOperationFunctionInvoker | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    machine_user: executorOperationFunctionInvokerMachineUserToTerraform(struct!.machineUser),
  }
}


export function executorOperationFunctionInvokerToHclTerraform(struct?: ExecutorOperationFunctionInvoker | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    machine_user: {
      value: executorOperationFunctionInvokerMachineUserToHclTerraform(struct!.machineUser),
      isBlock: true,
      type: "struct",
      storageClassType: "ExecutorOperationFunctionInvokerMachineUser",
    },
  };
...
export class ExecutorOperationFunctionInvokerOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ExecutorOperationFunctionInvoker | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ExecutorOperationFunctionInvoker | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _machineUser = new ExecutorOperationFunctionInvokerMachineUserOutputReference(this, "machine_user");
  public get machineUser() {
    return this._machineUser;
  }
  public putMachineUser(value: ExecutorOperationFunctionInvokerMachineUser) {
...
export interface ExecutorOperationFunction {
  /**
  * The invoker of the operation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#invoker Executor#invoker}
  */
  readonly invoker?: ExecutorOperationFunctionInvoker;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#script Executor#script}
  */
  readonly script: string;
  /**
  * The variables to pass to the function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#variables Executor#variables}
  */
  readonly variables?: string;
}

export function executorOperationFunctionToTerraform(struct?: ExecutorOperationFunction | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    invoker: executorOperationFunctionInvokerToTerraform(struct!.invoker),
    name: cdktf.stringToTerraform(struct!.name),
...
export function executorOperationFunctionToHclTerraform(struct?: ExecutorOperationFunction | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    invoker: {
      value: executorOperationFunctionInvokerToHclTerraform(struct!.invoker),
      isBlock: true,
      type: "struct",
      storageClassType: "ExecutorOperationFunctionInvoker",
    },
    name: {
      value: cdktf.stringToHclTerraform(struct!.name),
      isBlock: false,
...
export class ExecutorOperationFunctionOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ExecutorOperationFunction | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ExecutorOperationFunction | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _invoker = new ExecutorOperationFunctionInvokerOutputReference(this, "invoker");
  public get invoker() {
    return this._invoker;
  }
  public putInvoker(value: ExecutorOperationFunctionInvoker) {
...
export interface ExecutorOperationTailorGraphql {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#app_name Executor#app_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#query Executor#query}
  */
...
export interface ExecutorOperationWebhookHeadersSecretValue {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#secret_name Executor#secret_name}
  */
  readonly secretName: string;
  /**
  * The name of the vault.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#vault_name Executor#vault_name}
  */
...
export interface ExecutorOperationWebhookHeaders {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#key Executor#key}
  */
  readonly key: string;
  /**
  * The raw value of the header.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#raw_value Executor#raw_value}
  */
  readonly rawValue?: string;
  /**
  * The secret value to load.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#secret_value Executor#secret_value}
  */
...
export interface ExecutorOperationWebhookSignatureSecret {
  /**
  * The name of the secret.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#secret_name Executor#secret_name}
...
export function executorOperationWebhookSignatureSecretToTerraform(struct?: ExecutorOperationWebhookSignatureSecret | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function executorOperationWebhookSignatureSecretToHclTerraform(struct?: ExecutorOperationWebhookSignatureSecret | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ExecutorOperationWebhookSignatureSecretOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ExecutorOperationWebhookSignatureSecret | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ExecutorOperationWebhookSignatureSecret | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._secretName = undefined;
...
export interface ExecutorOperationWebhook {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#body Executor#body}
  */
  readonly body?: string;
  /**
  * The headers to send with the webhook.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#headers Executor#headers}
  */
  readonly headers?: ExecutorOperationWebhookHeaders[] | cdktf.IResolvable;
  /**
  * The secret value to load.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#signature_secret Executor#signature_secret}
  */
  readonly signatureSecret?: ExecutorOperationWebhookSignatureSecret;
  /**
  * The URL of the webhook.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#url Executor#url}
  */
  readonly url: string;
}
...
export function executorOperationWebhookToTerraform(struct?: ExecutorOperationWebhook | cdktf.IResolvable): any {
  ...
  return {
    ...
    signature_secret: executorOperationWebhookSignatureSecretToTerraform(struct!.signatureSecret),
...
export function executorOperationWebhookToHclTerraform(struct?: ExecutorOperationWebhook | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    signature_secret: {
      value: executorOperationWebhookSignatureSecretToHclTerraform(struct!.signatureSecret),
      isBlock: true,
      type: "struct",
      storageClassType: "ExecutorOperationWebhookSignatureSecret",
    },
    url: {
...
export class ExecutorOperationWebhookOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _signatureSecret = new ExecutorOperationWebhookSignatureSecretOutputReference(this, "signature_secret");
  public get signatureSecret() {
    return this._signatureSecret;
  }
  public putSignatureSecret(value: ExecutorOperationWebhookSignatureSecret) {
...
export interface ExecutorOperation {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#function Executor#function}
  */
  readonly function?: ExecutorOperationFunction;
  /**
  * configuration for the graphql operation to Tailor Platform
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#tailor_graphql Executor#tailor_graphql}
  */
  readonly tailorGraphql?: ExecutorOperationTailorGraphql;
  /**
  * configuration for the webhook operation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#webhook Executor#webhook}
  */
...
export function executorOperationToTerraform(struct?: ExecutorOperation | cdktf.IResolvable): any {
  ...
  return {
    function: executorOperationFunctionToTerraform(struct!.function),
...
export function executorOperationToHclTerraform(struct?: ExecutorOperation | cdktf.IResolvable): any {
  ...
  const attrs = {
    function: {
      value: executorOperationFunctionToHclTerraform(struct!.function),
      isBlock: true,
      type: "struct",
      storageClassType: "ExecutorOperationFunction",
    },
    tailor_graphql: {
...
export class ExecutorOperationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _function = new ExecutorOperationFunctionOutputReference(this, "function");
  public get function() {
    return this._function;
  }
  public putFunction(value: ExecutorOperationFunction) {
...
export interface ExecutorTriggerEvent {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#condition Executor#condition}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#type Executor#type}
  */
...
export interface ExecutorTriggerSchedule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#frequency Executor#frequency}
  */
  readonly frequency: string;
  /**
  * The timezone for the schedule trigger.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#timezone Executor#timezone}
  */
...
export interface ExecutorTrigger {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#event Executor#event}
  */
  readonly event?: ExecutorTriggerEvent;
  /**
  * The configuration for the schedule trigger.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#schedule Executor#schedule}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor tailor_executor}
*/
export class Executor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Executor that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.25/docs/resources/executor tailor_executor} Resource
  *
  * @param scope The scope in which to define this construct
