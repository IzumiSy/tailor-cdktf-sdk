// https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/stateflow
...
export interface StateflowConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/stateflow#admins Stateflow#admins}
  */
  readonly admins?: string[];
  /**
  * Namespace name for this StateFlow.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/stateflow#namespace Stateflow#namespace}
  */
  readonly namespace: string;
  /**
  * The ID of the workspace that the StateFlow belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/stateflow#workspace_id Stateflow#workspace_id}
  */
  readonly workspaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/stateflow tailor_stateflow}
*/
export class Stateflow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Stateflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/stateflow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/stateflow tailor_stateflow} Resource
  *
  * @param scope The scope in which to define this construct
