// https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/auth_oauth2_client
...
export interface AuthOauth2ClientConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/auth_oauth2_client#description AuthOauth2Client#description}
  */
  readonly description?: string;
  /**
  * The list of grant types for this OAuth2 client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/auth_oauth2_client#grant_types AuthOauth2Client#grant_types}
  */
  readonly grantTypes?: string[];
  /**
  * The name of this OAuth2 client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/auth_oauth2_client#name AuthOauth2Client#name}
  */
  readonly name: string;
  /**
  * The auth namespace of the OAuth2 client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/auth_oauth2_client#namespace AuthOauth2Client#namespace}
  */
  readonly namespace: string;
  /**
  * The list of redirect URIs for this OAuth2 client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/auth_oauth2_client#redirect_uris AuthOauth2Client#redirect_uris}
  */
  readonly redirectUris?: string[];
  /**
  * The ID of the workspace that the OAuth2 client belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/auth_oauth2_client#workspace_id AuthOauth2Client#workspace_id}
  */
  readonly workspaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/auth_oauth2_client tailor_auth_oauth2_client}
*/
export class AuthOauth2Client extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthOauth2Client that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/auth_oauth2_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/auth_oauth2_client tailor_auth_oauth2_client} Resource
  *
  * @param scope The scope in which to define this construct
