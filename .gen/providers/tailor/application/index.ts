// https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/application
...
export interface ApplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/application#allowed_ip_addresses Application#allowed_ip_addresses}
  */
  readonly allowedIpAddresses?: string[];
  /**
  * The auth configuration of the application for user authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/application#auth Application#auth}
  */
  readonly auth?: ApplicationAuth;
  /**
  * The list of allowed origins for CORS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/application#cors Application#cors}
  */
  readonly cors?: string[];
  /**
  * The name of the application.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/application#name Application#name}
  */
  readonly name: string;
  /**
  * The list of subgraphs to use for the application.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/application#subgraphs Application#subgraphs}
  */
  readonly subgraphs: ApplicationSubgraphs[] | cdktf.IResolvable;
  /**
  * The ID of the workspace that the application belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/application#workspace_id Application#workspace_id}
  */
...
export interface ApplicationAuth {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/application#idp_config_name Application#idp_config_name}
  */
  readonly idpConfigName?: string;
  /**
  * The namespace of the auth resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/application#namespace Application#namespace}
  */
...
export interface ApplicationSubgraphs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/application#type Application#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/application tailor_application}
*/
export class Application extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Application that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/resources/application tailor_application} Resource
  *
  * @param scope The scope in which to define this construct
