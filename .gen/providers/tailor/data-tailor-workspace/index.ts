// https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/data-sources/workspace
...
export interface DataTailorWorkspaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/data-sources/workspace#id DataTailorWorkspace#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/data-sources/workspace tailor_workspace}
*/
export class DataTailorWorkspace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTailorWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/data-sources/workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailor-platform/tailor/0.0.9/docs/data-sources/workspace tailor_workspace} Data Source
  *
  * @param scope The scope in which to define this construct
